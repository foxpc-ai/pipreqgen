...
def main():
    ...
    parser.add_argument(
        "filename",
        type=str,
        help="filepath of the file for which requirements.txt needs to be generated for",
    )
    parser.add_argument(
        "--append",
        action="store_true",
        help="append to requirements.txt if flag is set, otherwise create a new file",
    )
